...
public class NetClientGetAboutNitin {
	...
	private static  String urlmr="http://192.168.2.102:8080/PSPolitics/json/aboutnitin/mr/get";
	private static  String urlhn="http://192.168.2.102:8080/PSPolitics/json/aboutnitin/hn/get";
